...
def parse_args():
    parser = argparse.ArgumentParser(description="RISORS Topology & Geometry Evaluation")
    parser.add_argument("--data-root", default="/data0/data/Aerial_R1_Dataset", help="数据集统一根目录")
    parser.add_argument("--json-file", default="/data0/data/Aerial_R1_Dataset/risors/val/annotations.json", help="RISORS测试集JSON")
    parser.add_argument("--work-dir", default="./results/tdpo-8b-wo-sft/risors_test", help="保存可视化和指标的目录")
...
def main():
    ...
    # 🌟 使用 tqdm 包装 dataset
    pbar = tqdm(dataset, desc="Evaluating RISORS")
    ...
    print("\n" + "="*50)
    print("🌍 RISORS Test Set Evaluation Finished!")
