...
pretrained_pth = os.environ.get(
    "TOPO_BASE_CHECKPOINT", "./models/Sa2VA-InternVL3-8B.pth"
)
...
DATA_ROOT = os.environ.get(
    "TOPO_DATA_ROOT", "/data0/data/Aerial_R1_Dataset/"
)  # dataset root

sa2va_data_finetune_configs = [
    dict(
        type=AerialR1SFTDataset,             # ⚠️ 换成我们的新引擎
        name='Aerial-R1-SFT-Mix-116k',
        data_root=DATA_ROOT,
        ann_file='sft_mix_train.json', # ⚠️ 指向混好的 JSON
        arch_type='intern_vl',
